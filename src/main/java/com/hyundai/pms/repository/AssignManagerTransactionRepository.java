...
public interface AssignManagerTransactionRepository extends JpaRepository<AssignManagerTransaction, Integer> {
	...
	@Query(value = "select pmt.proj_man_trans_id, p.project_name as projectName, pmt.manager_id as managerId, e.first_name as managerName, pmt.start_date as startDate, pmt.end_date as endDate, pmt.status from assign_manager_transaction pmt "
