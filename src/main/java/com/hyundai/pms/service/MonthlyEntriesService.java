...
public class MonthlyEntriesService {
	...
	public Response getAllConsolidated() {
		List<Map<String, Object>> list = monthlyEntriesRepository.getAllConsolidated();
		return new Response(1, "Success", list);
	}
	
	public Response getGrandTotal() {
		List<Map<String, Object>> list = monthlyEntriesRepository.getGrandTotal();
		return new Response(1, "Success", list);
	}
